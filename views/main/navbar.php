...
<head>
    ...
    <!-- Font Awesome-->
    <link rel="stylesheet" href="/SOURCE_REF/public/plugins/fontawesome-free/css/all.min.css">
    <!-- DataTables-->
    <link rel="stylesheet" href="/SOURCE_REF/public/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="/SOURCE_REF/public/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" href="/SOURCE_REF/public/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    <!-- Theme style-->
    <link rel="stylesheet" href="/SOURCE_REF/public/dist/css/adminlte.min.css">
    <!-- Add Style -->
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="index.html"><img src="/SOURCE_REF/public/uploads/favicon.png" class="img-fluid" alt="">VN<span>GREEN</span></a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="logo me-auto me-lg-0"><img src="/SOURCE_REF/public/assets/img/logo.png" alt="" class="img-fluid"></a>-->
